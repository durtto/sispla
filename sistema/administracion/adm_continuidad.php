...
Ext.onReady(function(){
	...
	camposReq['co_garantia'] = 'Codigo Continuidad';
  ...
  var storeContinuidad = new Ext.data.JsonStore({
    ...
    storeContinuidad.setDefaultSort('co_garantia', 'ASC');
	
	//total de espacio posible para que se vea sin barra de desplazamiento vertical 639//
    var colModelContinuidad = new Ext.grid.ColumnModel([
        {id:'co_garantia',header: "Continuidad", width: 100, sortable: true, locked:false, dataIndex: 'co_garantia'},
		...
		items: [{
			...
			handler: function(){
						...
						else
						{
							...
							storeContinuidad.baseParams = {'accion': 'refrescar', 'interfaz': '../interfaz/interfaz_garantia.php'};
						}
				}
			},{
			id: 'btnEliminar',
...
storeContinuidad.load({params: { start: 0, limit: 50, accion:"refrescar", interfaz: "../interfaz/interfaz_garantia.php"}});

// JavaScript Document
	...
	// Validacion con formato de solo letras
	Ext.form.VTypes["validos%"] =  /^([-_.,a-zA-Z0-9\/:Ò—#%&+*;\)\( ])+$/i;
	Ext.form.VTypes["validos%Mask"] = /([-_.,a-zA-Z0-9\/:Ò—#%&+*;\)\( ])/i; //[A-Z]|[0-9]| ||||||||||||||||-|_|#|&|+|,|.|\/|\(|\)|*
...
//	if(this.getEl().id=='va_precio_leche') {
	...
	cont_coment += '<td id="tdContenido" background="../imagenes/Comentario/coment_NS_azul_r3_c3.gif"><table><tr><td class="celda_med_Negro">Fecha ActualizaciÛn: '+convFechaDMY(fecha)+'</td><td align="left" class="txto_variosPeqNegro"></td></tr>';

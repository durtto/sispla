 ...
 */
	...
	var gridForm = new Ext.FormPanel({
		...
		labelWidth: 100,
		frame:true,
		title: '.: Reporte del Crecimiento Natural :.',
...
storeCrecimiento.load({params: {start: 0, limit: 50, accion:"refrescar", interfaz: "../interfaz/interfaz_crecimiento.php", ubicacion: ubicacion}});

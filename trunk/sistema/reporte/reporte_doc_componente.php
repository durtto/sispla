...
/******************************************INICIO**StoreDocumento******************************************/     
  ...
  var storeDocumento = new Ext.data.JsonStore({
		...
		remoteSort : true,
		root: 'doc_componentes',
		baseParams: {start:0, limit:50, accion: "refrescar", interfaz: "../interfaz/interfaz_doc_componente.php"},	
        totalProperty: 'total',
		idProperty: 'co_doc_componente',
        fields: [{name: 'co_doc_componente'},
        		{name: 'nb_doc_componente'},
        		{name: 'resp'}]
        });
...
/******************************************INICIO**colModelDocumento******************************************/     
    ...
    var colModelDocumento = new Ext.grid.ColumnModel([
        {id:'co_doc_componente',header: "Documento", width: 100, hidden:true, sortable: true, locked:false, dataIndex: 'co_doc_componente'},
        {header: "Nombre", width: 100, sortable: true, locked:false, dataIndex: 'nb_doc_componente'},
      ]);
